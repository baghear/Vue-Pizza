...
<!--      <div>{{popupData.name}}</div>
    ...
    <div class="container">
      ...
      <div v-if="CART_STATE.totalCountPizza" class="cart-content">
        ...
        <div v-for="(cartItem, cartItemIndex) in CART_ITEMS"  :key="cartItemIndex" class="cart-item">
          ...
          <div class="item-count">
            <button class="item-count__btn button-circle" @click="minusItem(cartItemIndex)">-</button>
            <b>{{CART_STATE.countItems[cartItemIndex]}}</b>
            <button class="item-count__btn button-circle" @click="plusItem(cartItemIndex)">+</button>
          </div>
          <div class="cart-item__price">
            <b>{{cartItem.price}} Р</b>
          </div>
          <div>
            <button class="cart-item__btn button-circle" v-on:click="deleteItem(cartItemIndex)">
